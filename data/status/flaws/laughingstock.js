...
export const label = "Laughingstock";

export const type = "social";

export const cost = -5;

export const relatedStats = ["charisma", "manipulation", "appearance", "intimidate", "dominate"];
